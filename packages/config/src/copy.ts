...
export const CHARACTER_COPY = {
  ...
  startConversationInvite: (name: string) => `${name} is waiting.`,
...
export const DASHBOARD_COPY = {
  ...
  storageClean: "Every object is still pointed at.",
  storageWaiting: (count: number) =>
    `${count} waiting out the grace period before it can be removed`,
  storageOrphans: (count: number) => `${count} unreferenced`,
  storageReadyToSweep: (count: number) => `${count} ready to remove`,
