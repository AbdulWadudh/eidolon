...
export const AUTHOR_COPY = {
  ...
  portraitTitle: "Her portrait",
  portraitBlurb:
    "Rendered from her personality, plus anything you add here. Takes a minute or two on the GPU.",
  portraitExtraLabel: "Anything else to include",
  portraitExtraHint: "Clothing, setting, mood. Leave it blank to go on her description alone.",
  portraitGenerate: "Generate her portrait",
  portraitRegenerate: "Generate a new portrait",
  portraitQueued: "Queued. Her new face will appear here when the GPU is done.",
  portraitFailed: "Could not start the render.",
  portraitWaiting: "Rendering",
} as const;

export const GALLERY_COPY = {
  title: "Everything she has shown you",
  empty: "No pictures yet. Ask her for one and it will land here.",
  ...
  loading: "Looking through her pictures",
  ...
  useAsFace: "Use as her face",
  useAsBackground: "Chat background",
  deleteLabel: "Delete",
  deleted: "Deleted.",
  deleteFailed: "Could not remove that one.",
  setAsAvatar: "Set as her profile picture.",
  setAsFace: "She will look like this in new photos.",
...
export const CHARACTER_COPY = {
  ...
  backLabel: "Close her settings",
  sectionIdentity: "Identity",
  sectionMind: "Mind",
  sectionVoice: "Voice",
  sectionSharing: "Sharing",
  identityBlurb: "What she is called, and the first thing she says.",
  mindBlurb: "How she thinks, where you are, and what she will never do.",
  voiceBlurb: "How she sounds when she sends a voice note.",
  sharingBlurb: "Who else on this conductor can meet her.",
  darkLabel: "Dark mode",
  ...
  theirsEditable:
    "Change anything you like. Saving keeps a private copy for you and leaves hers as it is.",
  publishHintTheirs: "You can publish your own copy of her, once you have saved one.",
  ownerUnclaimed: "Unclaimed",
  forkWarning: "Your copy starts private. Publish it here when you want others to meet her.",
} as const;
