...
export const IMAGE = {
  ...
  framings: [
    ...
    "wide shot with them small in the frame and the place around them",
    "low angle from below, looking down at the lens",
    "cropped close on their face, half in shadow",
  ],
  flourishes: [
    "sunglasses pushed up into their hair",
    "wearing sunglasses",
    "hair tied up messily",
    "holding a drink",
    "one hand pushing their hair back",
  ...
  appearanceFallback:
    "a person in their late twenties, shoulder length dark hair, warm brown eyes, casual everyday clothes",
  captionMaxChars: 90,
  captionAttempts: 3,
  captionMinWords: 3,
  captionMaxWords: 14,
