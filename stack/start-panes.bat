...
rem One window, four panes: llama.cpp on the left, ComfyUI top right, Kokoro
rem TTS and embeddings filling the rest.
rem
...
"%WT_EXE%" new-tab --title Eidolon cmd /k "%HERE%\start-llm.bat" ^; split-pane -V cmd /k "%HERE%\start-comfy.bat" ^; split-pane -H cmd /k "%HERE%\start-tts.bat" ^; split-pane -V cmd /k "%HERE%\start-embed.bat"
