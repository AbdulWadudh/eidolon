...
- **Personas.** A user writes one or more, each with a name, a bio, a
...
- The character is told who it is talking to. `userContext` assembles the
...
- A persona can be **drawn**: the conductor reads what the user wrote,
...
transcript was the only thing carrying any sense of who the user was, and it
...
the user's biography back at them.
